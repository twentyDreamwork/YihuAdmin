...
public class Goods implements Serializable {
	 ...
	 * time,Integer timer，Date timerstart) { Goods goods= new Goods(); this.id = id;
	 * this.shopId = shopId; this.cateId = cateId; this.locaId = locaId;
	 * this.mainTitle = mainTitle; this.subTitle = subTitle; this.price = price;
	 * this.oldPrice = oldPrice; this.buy = buy; this.goodsImg = goodsImg;
	 * this.taobaoUrl=taobaoUrl; this.recommend=recommend; this.hot=hot;
	 * this.time=time; this.timer=timer; this.timestart=timestart; }
	 */	
}
