...
public enum CommonCode implements ResultCode {
    ...
    PAGENUM_ERROR(false, 401, "参数pageNum不能为空！"),
    PAGESIZE_ERROR(false, 401, "参数pageSize不能为空！"),
    CONFIG_ERROR(false, 401, "请先设置配置信息！"),
    ENVIRONMENT_ERROR(false, 401, "当前环境不允许此操作！"),
    PARAM_ERROR(false,401,"入参数据存在问题"),

    SELECT_ERROR(false, 401, "查询失败！"),
    DELETE_ERROR(false, 401, "删除失败！"),
    UPDATE_ERROR(false, 401, "更新失败！"),
    INSERT_ERROR(false, 401, "新增失败！"),
    ID_ERROR(false, 401, "新增数据id不能指定！"),
